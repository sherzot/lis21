...
Class clsP_CareerHistory
	...
	Public Sub Initialize()
		...
		Do While True
			...
			If sEntryDay <> "" Then
				...
				ReDim Preserve Period(MaxIndex) : If IsDate(EntryDay) = True And IsDate(RetireDay) = True Then Period(MaxIndex) = DateDiff("m", EntryDay(MaxIndex), RetireDay(MaxIndex)) / 12	'Request.Form("CONF_Period" & idx)
	...
	Public Function GetRegSQL(ByVal vStaffCode)
		...
		GetRegSQL = "EXEC sp_Del_P_CareerHistory '" & ChkSQLStr(vStaffCode) & "'" & vbCrLf

...
<%	End If %>
   ...
   <% If flgImg = True Then '画像が有る場合のレイアウト %>
    ...
    <div>
    <img src="<%= HTTP_NAVI_CURRENTURL %>img/order/list_typ.png">
    <p><%= sTitleJobName %></p>
    </div><!--職種-->
    
    <div>
    <img src="<%= HTTP_NAVI_CURRENTURL %>img/order/list_emp.png">
    <p><%= sWorkingType %></p>
     </div>
     
     <div>
     <img src="<%= HTTP_NAVI_CURRENTURL %>img/order/list_sal.png">
      <p id="salary">
    ...
    <div id="kinmuchi">
    <img src="<%= HTTP_NAVI_CURRENTURL %>img/order/list_loc.png">
...
Function DspOrderListDetail3(ByRef rDB, ByRef rRS, ByVal vPageSize, ByVal vPage, ByVal vRCMD)
	...
	Do While idx < iRecordCnt
		For iCols = 0 To MAXCOLS - 1
			...
			Response.Write "<div style=""float:left; width:235px; margin:0 2px;""><div style=""line-height:16px; " & aPadding(iCols) & """>"

...
'*******************************************************************************
Function htmlIndustryTypeCheckbox(ByVal vCode, ByVal vCols, ByVal vName)
	Dim sSQL
	Dim oRS
	Dim flgQE
	Dim sSQLErr
	...
	Do While GetRSState(oRS) = True
		...
		sHTML = sHTML & "<label><input name=""" & vName & """ type=""checkbox"" value=""" & dbIndustryTypeCode & """" & sChecked & ">" & dbIndustryTypeName & "</label>"
		sHTML = sHTML & "</td>"
	...
	htmlIndustryTypeCheckbox = sHTML
End Function
%>

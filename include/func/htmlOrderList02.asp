...
'戻り値：String
'備　考：
'履　歴：2018/12/01 LIS kera LP広告用にコピーして作成(01をコピー)
'*******************************************************************************
Function htmlOrderList02(ByRef rDB,ByVal vXML,ByVal vStr)
	...
	Do While GetRSState(oRS) = True
        ...
        sHTML = sHTML & "<div class=""line1""></div>"
		sHTML = sHTML & "<div style=""float:left;width:25%;"">【PR】</div><div style=""float:right;width:70%;"">" & dbPRTitle1 & "</div><div style=""clear:both;""></div>"

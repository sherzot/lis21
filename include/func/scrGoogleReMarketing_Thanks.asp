<%
'*******************************************************************************
'概　要：Googleリマーケティング：サンクスページに貼るタグ取得
'引　数：
'出　力：
'戻り値：String
'備　考：
...
'*******************************************************************************
Function scrGoogleRemarketing_Thanks()
	Dim sScript

	sScript = vbCrLf
	sScript = sScript & "<!-- Google Code for &#12522;&#12510;&#12540;&#12465;&#12486;&#12451;&#12531;&#12464;_&#12469;&#12531;&#12463;&#12473;&#12506;&#12540;&#12472;&#29992;&#12479;&#12464; Remarketing List -->" & vbCrLf
	...
	sScript = sScript & "var google_conversion_label = ""aeK6CNGT9wEQiY6v_gM"";" & vbCrLf
	...
	'sScript = sScript & "<img height=""1"" width=""1"" style=""border-style:none;"" alt="""" src=""https://www.googleadservices.com/pagead/conversion/1070319369/?label=aeK6CNGT9wEQiY6v_gM&amp;guid=ON&amp;script=0""/>" & vbCrLf
	sScript = sScript & "<img height=""1"" width=""1"" style=""border-style:none;"" alt="""" src=""https://www.googleadservices.com/pagead/conversion/1070319369/?label=aeK6CNGT9wEQiY6v_gM&amp;guid=ON&amp;script=0"">" & vbCrLf
	sScript = sScript & "</div>" & vbCrLf
	sScript = sScript & "</noscript>" & vbCrLf

	scrGoogleRemarketing_Thanks = sScript
End Function
%>

...
'*******************************************************************************
Function htmlPrefectureCheckbox(ByVal vCode, ByVal vCols, ByVal vName, ByVal vAttribute, ByVal vForeignFlag)
	Dim sSQL
	Dim oRS
	Dim flgQE
	Dim sSQLErr
	...
	For idx = 0 To CInt(vCols) - 1
		sHTML = sHTML & "<col style=""width:" & fWidth & "%;"">"
	Next
	sHTML = sHTML & "</colgroup>"
	sHTML = sHTML & "<tbody>"
	...
	Do While GetRSState(oRS) = True
		...
		sHTML = sHTML & "<label><input name=""" & vName & """ type=""checkbox"" value=""" & dbPrefectureCode & """" & sChecked & "" & vAttribute & ">" & dbPrefectureName & "</label>"
		sHTML = sHTML & "</td>"

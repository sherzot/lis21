...
'            sHTML10 = sHTML10 & "<a href=""https://www.youtube.com/watch?v=T3n06VU8T-Q" & HTTPS_CURRENTURL & "valueoffer/""TARGET="_blank"><img src=""/img/common/tutrial_banner01.png"" alt=""バリューオファー"" style=""margin-top:3px;""></a>"
	...
	sHTML10 = sHTML10 & "<div class=""floatingmenu"" id=""moveside""><div align=""center"" style=""margin:9px 0 5px;"">"
...
'		sHTML12 = sHTML12 & "<a href=""/neo/oiwai/"" target=""_blank"" id=""oiwai_page"">ポイント申請</a>"
	...
	If iTabIndexType = 0 Then
		...
		sHTML = sHTML & "<li class=""sidemenu""><a href=""" & HTTP_CURRENTURL & "promotion/s_conpri_riyou.asp""><img style=""width:70px;border:0px solid #000;vertical-align:middle;margin-left:8px;"" src=""/img/top/clogo_circlek.png""></a></li>"
        sHTML = sHTML & "<li class=""sidemenu""><a href=""" & HTTP_CURRENTURL & "promotion/s_conpri_riyou.asp""><img style=""width:70px;border:0px solid #000;vertical-align:middle;margin-left:8px;"" src=""/img/top/clogo_sunkus.png""></a></li>"
	...
	If SidemenuType <> 9 Then
       ...
       <ul>
		...
		<li class="sidemenu"><a href="<%= HTTP_CURRENTURL %>promotion/s_conpri_riyou.asp"><img style="width:70px;border:0px solid #000;vertical-align:middle;margin-left:8px;" src="/img/top/clogo_circlek.png"></a></li>
        <li class="sidemenu"><a href="<%= HTTP_CURRENTURL %>promotion/s_conpri_riyou.asp"><img style="width:70px;border:0px solid #000;vertical-align:middle;margin-left:8px;"" src="/img/top/clogo_sunkus.png"></a></li>
...
<div class="right" style="width:515px; border:1px solid #CCC; border-radius:8px; padding:0 10px 0 0;">
<div style="width:120px; float:left; background:#ededed; text-align:center; line-height: 90px; border-radius:8px 0 0 8px;">ログイン</div>
...
<div class="right" style="margin:5px 0;">
	...
	<div class="left center">
		ID
	<% If si <> "" Then %>
			<input type="text" name="CONF_UserID" value="<%= si %>" style="width:120px;">
	<%	Else %>
			<input type="text" name="CONF_UserID" value="<%= Request.Cookies("id_memory") %>" style="width:120px;">
	<%	End If %>
		パスワード<input type="password" name="CONF_Password" value="" style="width:120px;">
	</div>
<br clear="all">
	<div align="right" style="margin:5px 0;">
		...
		<input type="submit" value="ログイン" onclick="DataCheckIdreg(); return false">
<br>
		</div>
		</div>
        </div></div>

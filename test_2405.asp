    ...
    <div class="container">
		...
		<div class="navbar">
			<div class="top_nav">
				<div class="logo">
					<a href="./index.html">
						<img src="images/Logo/Web/Desctop1.svg" alt="">
					</a>
				</div>
				<div class="left_link">
		...
		<div class="header">
			<!-- form-section -->
			<form class="form" action="test_2405receive.asp" name="inquiry" method="POST">
				<div class="main-container">
					<div class="frame-1">
						...
						<div class="name-7">
							<input class="name-input-8" type="text" name="uname" aria-label="text" placeholder="例：山田 太郎" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input class="name-input-8" type="text"  name="cname" aria-label="text" placeholder="例：リス株式会社" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input class="name-input-8" type="text"  name="pref" aria-label="text" placeholder="例：埼玉県" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input class="name-input-8" type="email"  name="email" aria-label="email" placeholder="例：lis@lis21.co.jp" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input class="name-input-8" type="number"  name="mobile" aria-label="number" placeholder="例：07069505055" />
						</div>
					</div>
					...
					<div class="main-container-3">
						...
						<textarea class="right" name="douki" id="" cols="30" rows="10" placeholder=""></textarea><!-- ご応募動機をご入力ください  -->
					  </div>
					  	<div class="chek-box">
			...
			<footer>
				...
				<div class="footer-map">
					<iframe title="myFrame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6481.103588769505!2d139.69093757604216!3d35.68803667258506!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188cd3741a9df7%3A0x4fb5f8fb9f0a0195!2sShinjuku%20NS%20Building!5e0!3m2!1sen!2sjp!4v1715059757728!5m2!1sen!2sjp" width="600" height="450" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

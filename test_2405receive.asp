...
<% If Request.QueryString("mail_flag") = "" Then %>
		...
		<div class="header">
			<!-- form-section -->
			<form class="form" action="/mail/testmail.asp" method="POST">
				<div class="main-container">
					<div class="frame-1">
						...
						<div class="name-7">
							<input name="name" class="name-input-8" type="text" aria-label="text"  value="<% Response.Write username %>" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input name="company" class="name-input-8" type="text" aria-label="text"  readonly value="<% Response.Write company %>" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input name="prefecture" class="name-input-8" type="text" aria-label="text"  readonly value="<% Response.Write pref %>" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							 <input name="mail" class="name-input-8" type="email" aria-label="email"  readonly value="<% Response.Write emai %>" />
						</div>
					</div>
					<div class="frame-1">
						<div class="left-4">
						...
						<div class="name-7">
							<input name="mobile" class="name-input-8" type="number" aria-label="number"  readonly value="<% Response.Write mobileno %>" />
						</div>
					</div>
					...
					<div class="main-container-3">
						...
						<textarea class="right" name="douki" cols="30" rows="10"  readonly value=" <% Response.Write doukitext %> " > <% Response.Write doukitext %></textarea>
					  </div>
						...
						<div class="submit">
							<!-- <button type="button" class="submit" onclick="history.back()">前のページへ戻る</button>&nbsp; -->

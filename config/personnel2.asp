...
Dim BASEURL			'HTTP,HTTPSに柔軟に対応したURLの基本部分 ("http://www.shigotonavi.co.jp/")
Dim NAVI_BASEURL	'HTTP,HTTPSに柔軟に対応したしごとナビのURLの基本部分 ("http://www.shigotonavi.co.jp/")
Dim CURRENTURL
...
'履歴書FDFテンプレートパス
Const RESUME_VER3 = "F:\test-source\しごとナビ\staff\resume_ver3.fdf"
Const CAREERSHEET_OFFICE = "F:\test-source\しごとナビ\staff\careersheet_office.fdf"
Const CAREERSHEET_IT = "F:\test-source\しごとナビ\staff\careersheet-it.fdf"
...
'コンプリ用ＰＤＦファイル保存先
Dim ConpriFolder	:	ConpriFolder = "F:\test-source\しごとナビ\Conpri\infile\"
Dim ReportFolder	:	ReportFolder = "F:\test-source\帳票フォーマット"

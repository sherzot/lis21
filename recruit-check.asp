    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="list-menu">
                ...
                <form class="form" action="/mail/recruitmail.asp" method="POST" >
                    <div class="main-container">
                        ...
                        <div class="frame-1">
                            ...
                            <div class="radio">
                                <input type="radio" id="input5" name="input5" checked="checked"><!-- name="fav_language"  -->
                                  <label for="html"></label><br><!-- 本社営業部（紹介コンサル）  -->
                            </div>
                        </div>
                        ...
                        <div class="main-container-3">
                            ...
                            <textarea class="right"  id="input6" name="input6"   cols="30" rows="10""></textarea><!-- name="ご応募動機をご入力ください"  -->
                        </div>
                        <div class="chek-box">
    ...
    btn.addEventListener('mouseover', function() {
		...
		//	//btn.value="御社名が入力されていません。戻って修正してください。";
			...
			//btn.value="応募職種が入力されていません。戻って修正してください。";
			 alert('応募職種が入力されていません');
			btn.setAttribute('disabled','disabled');		
			
		} else if (!(input6.value)) {
			//btn.value="ご応募動機が入力されていません。戻って修正してください。";
			 alert('ご応募動機が入力されていません。戻って修正してください。');
			btn.setAttribute('disabled','disabled');

             ...
             d<iv class="right-content">
                 ...
                 <div class="job-text">
                     ...
                     <p>
                         ...
                         <br>リス株式会社
                         <br>〒163-0825 東京都新宿区西新宿２丁目４番１号 新宿ＮＳビル２５階 (本社企画推進室)
                         <br>◇ 転勤なし
                         <br>◇ 駅から徒歩13分以内
                     </p> <br>
                     <h3>
                     ...
                     <p>
                         <br>※上記額にはみなし残業代（月45時間）を含みます。超過分は全額支給します。
                     </p> br>
                     <h3>
                        休日休
                     </h3><br>
                 ...
                 <form class="form" action="">
                     <div class="main-container">
                         ...
                         <div class="main-container-3">
                             ...
                             textarea class="right"  id=""  name="input6"  cols="30" rows="10"
                                placeholder="ご応募動機をご入力ください"> /textarea>
                         </div>
                         <div class="chek-box">
                             <input type="checkbox" id="vehicle1" name="vehicle1" value="同意">

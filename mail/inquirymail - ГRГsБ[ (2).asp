...
'	Response.Write "doukitext= " & input6 & "<br>"
		...
		sBody = sBody &  " 会社名= " & input2 & vbCrLf 
		sBody = sBody &  " 都道府県= " & input3 & VbCrLf
		sBody = sBody &  " メール= " & input4 & vbCrLf 
'		sBody = sBody &  " 電話= "　& input5 & vbCrLf 
		sBody = sBody &  " 動機= " & input6 & vbCrLf 
